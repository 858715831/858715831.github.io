...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'yst', // 必需
      link: 'https://github.com/858715831', // 可选的
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: '0a676d854c8347ef6450',
          clientSecret: '3760f1a2a2192469c8e9e08a3daf81f73fb1c123',
          repo: '858715831.github.io', // GitHub 仓库
          owner: '858715831', // GitHub仓库所有者
          admin: ['858715831'], // 对仓库有写权限的人
